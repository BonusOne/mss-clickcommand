 ...
 */
final class Version20200511120250 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE redirect_data CHANGE date date DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE redirect_data CHANGE date date DATETIME NOT NULL');
    }
}
