 ...
 */
final class Version20200507121938 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE redirect_data ADD `delete` INT DEFAULT 0 NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE redirect_data DROP `delete`');
    }
}
