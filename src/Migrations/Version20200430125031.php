 ...
 */
final class Version20200430125031 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE click_statistics CHANGE id_company id_company INT UNSIGNED DEFAULT 2 NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX index_operating_system ON click_statistics');
        $this->addSql('DROP INDEX index_device ON click_statistics');
        $this->addSql('ALTER TABLE click_statistics CHANGE id_company id_company INT NOT NULL');
