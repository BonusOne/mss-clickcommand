 ...
 */
final class Version20200507123713 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE redirect_data CHANGE `delete` deleted INT DEFAULT 0 NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE redirect_data CHANGE deleted `delete` INT DEFAULT 0 NOT NULL');
    }
}
